...
class HomeViewController: UIViewController {
    ...
    func coffeeImg(_ myPercent: Double) {
        ...
        if myPercent > 80.0 {
            imgCoffee.image = UIImage(named: "i100")
        }else if myPercent > 60.0 {
            imgCoffee.image = UIImage(named: "i80")
        }else if myPercent > 40.0 {
            imgCoffee.image = UIImage(named: "i60")
        }else if myPercent > 20.0 {
            imgCoffee.image = UIImage(named: "i40")
        }else if myPercent > 0.0 {
            imgCoffee.image = UIImage(named: "i20")
        }else {
            imgCoffee.image = UIImage(named: "i0")
        }
    }
